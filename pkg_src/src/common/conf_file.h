...
#undef DECLARE_PARSE_INT
    ...
    // Adding parse_string method as per the build error
    static int parse_string(const char *val, size_t val_len, void *storage, size_t storage_len);
    static int parse_uc_vec(const char *val, size_t val_len, void *storage, size_t storage_len);
